...
_lr_productions = [
  ...
  ('program -> PROGRAM ID SEMICOLON decvar modules mainfunction','program',6,'p_program','bixoParser.py',172),
  ('decvar -> VAR decvarp','decvar',2,'p_decvar','bixoParser.py',178),
  ('decvar -> VAR decvarp decvar','decvar',3,'p_decvar','bixoParser.py',179),
  ('decvarp -> type decvarpp SEMICOLON','decvarp',3,'p_decvarp','bixoParser.py',185),
  ('decvarpp -> ID COMMA decvarpp','decvarpp',3,'p_decvarpp','bixoParser.py',229),
  ('decvarpp -> ID','decvarpp',1,'p_decvarpp','bixoParser.py',230),
  ('type -> INT','type',1,'p_type','bixoParser.py',239),
  ('type -> FLOAT','type',1,'p_type','bixoParser.py',240),
  ('function -> FUNCTION type decfunc LPAREN param RPAREN LBRACE body RBRACE','function',9,'p_function','bixoParser.py',244),
  ('decfunc -> ID','decfunc',1,'p_decfunc','bixoParser.py',255),
  ('voidfunction -> FUNCTION VOID ID LPAREN param RPAREN LBRACE body RBRACE','voidfunction',9,'p_voidfunction','bixoParser.py',261),
